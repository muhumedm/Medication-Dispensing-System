...
- Sends that confirmation back to the system and notifies the carer through email
"""
...
###### Blinks LED, plays buzzer, and waits for button confirmation
...
# ========== MAIN LOOP ========== #
###### Repeats forever to check and alert for new doses
seen_dose_ids = set()
...
try:
    ...
    lgpio.gpiochip_close(CHIP)  # Free up GPIO
